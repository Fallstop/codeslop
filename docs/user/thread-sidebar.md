...
When you change a new thread's project, codeslop stays in the current environment
...
If dragging is unavailable for one environment, update the codeslop server running in that
