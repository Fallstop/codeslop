...
Both instances must use the same **CODEX_HOME path**. codeslop prepares the shared
...
Choose the other account from the thread's model picker. codeslop offers compatible
