...
also send files to codeslop through another app's system share sheet.
...
codeslop remembers your provider, model, and model options for new threads. A
...
Transcription runs on your device. codeslop deletes the temporary audio after
...
Provider commands must start the message to run. codeslop commands such as
...
automatically. HTML previews cannot access your codeslop session.
