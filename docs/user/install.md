...
there. Install the provider CLIs inside that distro. codeslop installs its own
...
Pass a path, such as `slop app ../my-project`, to open another directory. It requires
