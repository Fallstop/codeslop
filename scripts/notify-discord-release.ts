  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new codeslop prerelease is available for nightly testers."
          : "A new codeslop latest release is available.",
...
).pipe(Command.withDescription("Post a codeslop release announcement to Discord."));
