export const BRAND_ASSET_PATHS = {
  ...
  productionIosIconPng: "assets/prod/codeslop-ios-1024.png",
  productionMacIconPng: "assets/prod/codeslop-macos-1024.png",
  productionLinuxIconPng: "assets/prod/codeslop-universal-1024.png",
  productionWindowsIconIco: "assets/prod/codeslop-windows.ico",
  productionWebFaviconIco: "assets/prod/codeslop-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/codeslop-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/codeslop-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/codeslop-web-apple-touch-180.png",
