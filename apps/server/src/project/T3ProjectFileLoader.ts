 ...
 * (or `slop.json`) project file from a workspace root.
 *
...
/** Service tag for t3.json/slop.json project file loading. */
export class T3ProjectFileLoader extends Context.Service<
  T3ProjectFileLoader,
  {
    /**
     * Load and decode the project file at the workspace root, trying
     * `slop.json` then `t3.json`; the first existing file wins.
     *
