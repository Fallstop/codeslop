...
// rest of it being loadable. It ships as a standalone bundle copied to a
// stable path by `slop service update`.
...
export async function main(): Promise<void> {
  ...
  if (baseDir === undefined || baseDir === "") {
    throw new Error("T3CODE_HOME is required by the codeslop service launcher.");
  }
