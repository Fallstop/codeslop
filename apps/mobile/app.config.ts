    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active codeslop agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow codeslop to connect to codeslop servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow codeslop to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow codeslop to access your camera so you can scan pairing QR codes.",
