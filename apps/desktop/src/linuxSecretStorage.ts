...
function getGnomeKeyringRemediationMessage(): string {
  return "codeslop could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart codeslop.";
}

function getKWalletRemediationMessage(): string {
  return "codeslop could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart codeslop.";
}
