...
describe("theme files", () => {
  it("derives a readable palette from extreme simple-editor colors", () => {
    ...
    // Status colors fall back to codeslop's standard red and amber rather than
  ...
  it("keeps the codeslop Acid palette faithful and readable", () => {
...
describe("stored theme preferences", () => {
  ...
  it("resolves the legacy t3-chat-dark preference to dark codeslop Acid", () => {
