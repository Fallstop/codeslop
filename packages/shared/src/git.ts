...
// Canonical form is `slop/<8 hex>` (previously `t3code/<8 hex>`). Older mobile builds
// generated `t3code/<uuid>` via Crypto.randomUUID() (always RFC 4122 v4), so the matcher
// also accepts exactly that shape — version nibble `4`, variant nibble `[89ab]` — to keep
// those threads eligible for branch regeneration without loosening beyond what was ever
// generated.
