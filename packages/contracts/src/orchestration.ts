...
export const OrchestrationThread = Schema.Struct({
  ...
  /**
   * Set when this thread is a side chat opened from another thread. Side chats
   * are real threads with their own session and tools; they are kept out of the
...
export class OrchestrationGetThreadBackgroundTasksError extends Schema.TaggedError<OrchestrationGetThreadBackgroundTasksError>()(
...
export class OrchestrationHandoffBundleError extends Schema.TaggedError<OrchestrationHandoffBundleError>()(
