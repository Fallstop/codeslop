...
export const AsideId = makeEntityId("AsideId");
export type AsideId = typeof AsideId.Type;
export const AsideMessageId = makeEntityId("AsideMessageId");
export type AsideMessageId = typeof AsideMessageId.Type;
